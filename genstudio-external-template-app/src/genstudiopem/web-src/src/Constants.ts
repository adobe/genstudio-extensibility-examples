...
export const EXTENSION_ID: string = "genstudio-example:external-template-app";
export const EXTENSION_LABEL: string =
  "GenStudioExample - External Template App";
...
export const LOAD_TEMPLATE_ACTION =
  "genstudio-external-template-app/get-templates";

/**
 * App metadata object
 * Configure this object as per your needs. Ex. specific channels for templates.
 */
