...
export const EXTENSION_ID: string = "genstudio-example:mlr-claims-app";
export const EXTENSION_LABEL: string = "GenStudioExample - MLR for Celestix";
...
export const VALIDATION_APP_ROUTE: string = "/right-panel";
export const PROMPT_APP_ROUTE: string = "/additional-context-dialog";
