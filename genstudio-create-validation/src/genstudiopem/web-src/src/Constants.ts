...
export const EXTENSION_ID: string = "genstudio-example:create-validation-app";
export const EXTENSION_LABEL: string =
  "GenStudioExample - Create Validation App";
...
export const APP_ROUTE: string = "/right-panel";
