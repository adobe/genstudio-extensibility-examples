...
This is an App Builder App that creates a GenStudio Add-On to add an external source for selecting assets for experience creation in GenStudio. The external source for this app is an S3 bucket, but can be extended to support other DAM systems.

## Prerequisites

To run this app, you need the following:

- **S3 Bucket** - AWS S3 bucket to store assets
