...
export const EXTENSION_ID: string = "genstudio-example:external-s3-dam";
export const EXTENSION_LABEL: string = "GenStudioExample - External S3 DAM [LOCAL]";
...
export const SEARCH_ASSETS_ACTION = "genstudio-external-dam-app/search";

/**
 * App metadata object
 * Configure this object as per your needs. Ex. specific channels for assets.
 */
