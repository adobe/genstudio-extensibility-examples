...
import { FieldSwapPanel } from "../components/FieldSwapPanel";
import { FIELD_SWAP_PANEL_ROUTE } from "../Constants";
      ...
      >
        <Router>
          <Routes>
            ...
            <Route path={FIELD_SWAP_PANEL_ROUTE} element={<FieldSwapPanel />} />
          </Routes>
        </Router>
      </S2Provider>
    </ErrorBoundary>
