...
module.exports = (config) => {
  try {
    ...
    console.log(
      chalk.green(chalk.bold(`base64EncodedData: ${base64EncodedData}`))
    );
    console.log(
      chalk.magenta(
        chalk.bold(
          "For a developer preview of your UI extension in the GenStudio environment, follow the URL:"
        )
      )
    );
    ...
    console.log(
      chalk.magenta(
        chalk.bold(
          `  -> https://experience${env}.adobe.com/?devMode=true&ext=https://localhost:9080#/@gdccsc/genstudio/`
        )
      )
    );
  } catch (error) {
